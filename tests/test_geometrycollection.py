...
@pytest.fixture
def expected_geometries(point000, c000, c100, c001):
    yield [point000, LineString([c000, c100, c001]), Polygon([c000, c100, c001])]
...
def test_vertical_centroid(
    ...
    assert (collection.centroid(compute_2d_area) is not None) ^ compute_2d_area
